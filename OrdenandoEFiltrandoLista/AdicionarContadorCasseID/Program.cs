    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var item in listaOrdenada)
                ...
                Console.WriteLine($"Id {item.Id} Nome {item.Nome} Carteira {item.ValorCarteira} Data nascimento: {item.DataNascimento.ToShortDateString()}.");
            ...
            foreach (var item in listaOrdenadaNascimento)
                ...
                Console.WriteLine($"Id {item.Id} Nome {item.Nome} Carteira {item.ValorCarteira} Data de nascimento {item.DataNascimento.ToShortDateString()}");
            ...
            (from valorCarteira in listaDePessoas
             ...
             .ToList<Pessoas>()
             .ForEach(i => Console.WriteLine($"Nome com mais de 500  {i.Nome} Valor {i.ValorCarteira}"));
